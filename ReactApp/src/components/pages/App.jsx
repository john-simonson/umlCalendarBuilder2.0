  ...
  React.useEffect(() => {
    ...
    getAuth().onAuthStateChanged((user) => {
      ...
      selectDataUser(user.uid).then(function (usr){
        ...
        setTimeout(() => {
          const [tmpDays, tmpMsg] = todaysClasses(usr.classes, calendar);
          var tmpArr = [];
          tmpArr.push("");
          //console.log(tmpDays);
      ...
      <div className="flex justify-center pt-10 rounded-md overflow-y-auto">
        <div className="bg-indigo-400 text-white w-4/6 border border-solid border-white rounded-2xl">
            ...
            {(message !== null && message !== undefined) && (
              ...
              <h3 className="flex justify-center text-md font-bold py-2 border-b"> {message} </h3>
              </div>
            )}
            <h1 className="flex justify-center text-2xl font-bold py-2 border-b">Today's Classes</h1>
